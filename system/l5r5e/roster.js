// system/l5r5e/roster.js — the characters this browser keeps: several, one current. State
...
window.L5RRoster = (function () {
  const KEY = ((window.VttConfig || {}).storagePrefix || 'sortilege-vtt-l5r5e') + ':site:roster';
