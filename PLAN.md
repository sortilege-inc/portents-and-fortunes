...
**Corpus defects found while building** are reported in `titterpig-dsl-l5r5e/TODO.md`, not patched
here: the Vigilance FORMULA's "(rounded down)", three pregens' Focus, the pregens' `Ninjo` spelling.
